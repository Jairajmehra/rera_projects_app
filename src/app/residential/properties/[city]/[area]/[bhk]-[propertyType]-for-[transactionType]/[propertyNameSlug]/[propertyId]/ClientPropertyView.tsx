        ...
        <div className="flex-1 p-4">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700">
              Beautiful {property.bhk} located in {property.locality}, {city}. This {property.propertyType} offers modern amenities and is {property.condition}. Perfect for families looking for a comfortable living space in a prime location.
            </p>
          </div>
        ...
        <nav className="flex mb-6" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            ...
            <li className="flex items-center">
              ...
              <Link href="/residential/properties" className="ml-2 text-gray-500 hover:text-gray-700">Properties</Link>
            </li>
            <li className="flex items-center">
              <svg className="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed mt-4">
                  The property features spacious rooms, modern fixtures, and is conveniently located near essential amenities. Enjoy the comfort of a well-designed living space with excellent connectivity to major parts of the city.
                </p>
              </div>
